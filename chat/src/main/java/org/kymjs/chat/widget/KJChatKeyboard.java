...
public class KJChatKeyboard extends RelativeLayout implements
    ...
    private void initWidget() {
        ...
        // Click the plus sign next to the expression button
    ...
    public void setFaceData(List<String> faceData) {
        ...
        if (layoutType == LAYOUT_TYPE_MORE) {
            ...
            //Plus 1 is the first classified as the default emoji expression classification,
            // this classification is fixed can not be changed
    ...
    public void showLayout() {
        ...
        // Delay for a while, so that the keyboard first hide and then show the expression keyboard,
        // otherwise there will be an instant expression keyboard and soft keyboard at the same time display
