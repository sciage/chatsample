    ...
    public View getView(final int position, View v, ViewGroup parent) {
      ...
      //  holder.tv_date.setText(StringUtils.friendlyTime(StringUtils.getDataTime("yyyy-MM-dd " + "HH:mm:ss")));
        ...
        if (data.getType() == Message.MSG_TYPE_TEXT) {
            ...
            //If the memory cache to show the picture, and to display the picture is not a holder reuse the picture,
            // then do nothing, otherwise it shows a loading of the picture
        ...
        //If it is an expression or picture, do not show the bubble, if it is a picture shows the bubble
        if (data.getType() != Message.MSG_TYPE_TEXT) {
        ...
        if (listener != null) {
            holder.tv_chatcontent.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Toast.makeText(v.getContext(), "chat content", Toast.LENGTH_SHORT).show();
                }
            });
                ...
                public void onClick(View v) {
                    switch (data.getType()) {
                        ...
                        case Message.MSG_TYPE_FACE:
                            ...
                            Toast.makeText(v.getContext(), "clicked user", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }
            });
